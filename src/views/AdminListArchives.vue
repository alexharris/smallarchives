<template>
  <div >
    ...
    <div v-else>
      ...
      <b-row>
        <b-table hover :items="archives" :fields="fields" class="table-bordered">
          <template slot="actions" scope="row">
            <b-btn size="sm" variant="outline-dark" @click.stop="details(row.item.key)">Details</b-btn>&nbsp;
            <b-btn size="sm" variant="outline-dark" @click.stop="linkToPublicView(row.item)">View</b-btn>&nbsp;
          </template>
        </b-table>
      </b-row>
    </div>
